...
def ensemble_llm_score(column_descriptions: Dict[str, str], question: str, predicted_entity=None, num_iterations: int = 3) -> Dict:
    ...
    debug_scores = {
        ...
        "mean_std_reliability": mean_std_reliability,
        "adjusted_scores": adjusted_scores
    }
    # print(f"[EnsembleLLMScore] Debug Scores: {debug_scores}")
...
def column_relevance_fn(state):
    ...
    llm_result = ensemble_llm_score(column_desc, question, predicted_entity, num_iterations=3)
    llm_scores = llm_result["adjusted_scores"]
    debug_llm_scores = llm_result["debug_scores"]
    # print(f"[ColumnRelevance] LLM Debug Scores: {debug_llm_scores}")
    ...
    return {**state, 
            ...
            "llm_debug_scores": debug_llm_scores,
            "column_similarity_scores": similarity_scores
            }
